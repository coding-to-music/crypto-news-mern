...
https://github.com/coding-to-music/crypto-news-mern

https://crypto-news-mern.herokuapp.com
...
git branch -M main
git remote add origin git@github.com:coding-to-music/crypto-news-mern.git
...
```java
heroku create crypto-news-mern
```
...
heroku config:set PUBLIC_URL="https://crypto-news-mern.herokuapp.com"
```
...
```java
=== crypto-news-mern Buildpack URL
heroku/nodejs
```
...
```java
Buildpack added. Next release on crypto-news-mern will use:
  1. heroku/nodejs
...
```java
Upgrading /mnt/volume_nyc1_01/crypto-news-mern/package.json
[====================] 15/15 100%
...
```java
Upgrading /mnt/volume_nyc1_01/crypto-news-mern/client/package.json
[====================] 18/18 100%
